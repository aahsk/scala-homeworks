...
import com.aahsk.homeworks.typeclass.Implicits.SuperVipCollections4s._
import com.aahsk.homeworks.typeclass.Implicits.SuperVipCollections4s.syntax._
import com.aahsk.homeworks.typeclass.ImplicitsSpec.TestValue
...
class ImplicitsSpec extends AnyFreeSpec with Matchers {
  ...
  "Iterate2 instances provided" - {
    "for Map" in {
      assertCompiles(
        """import com.aahsk.homeworks.typeclass.Implicits.SuperVipCollections4s._
          |import com.aahsk.homeworks.typeclass.Implicits.SuperVipCollections4s.instances._
          |
  ...
  "TwitCache" - {
    import com.aahsk.homeworks.typeclass.Implicits.MyTwitter._
